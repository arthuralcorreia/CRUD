...
é necessário ter o node e o NPM instalado. O repositorio já contém um arquivo sh que automatiza a intalação. Para tanto é necessário executar o seguinte comando:
